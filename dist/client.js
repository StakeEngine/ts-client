...
const RGSClient = (options) => {
    console.log(`Stake Engine Client Version: ${data.default.version}`, 'background: #222; color: #e9bc6fff');
    const client = {};
    ...
    client.Play = async (params) => {
        ...
        if (params.amount < client.authenticateConfig.minBet ||
